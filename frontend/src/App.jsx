...
function App() {
    ...
    return (
        <AnimatePresence>
            <div className="h-auto flex items-center justify-center min-w-[680px] font-raleway">
                {isLoading ||
                    (!user && (
                ...
                {isSongPlaying && (
                    <motion.div
                        ...
                        exit={{ opacity: 0, y: 50 }}
                        className={`fixed min-w-[700px] h-26  inset-x-0 bottom-0  bg-[#1E1E1E] drop-shadow-2xl backdrop-blur-md flex items-center justify-center`}
                    >
                        <MusicPlayer />
                    </motion.div>
                )}
