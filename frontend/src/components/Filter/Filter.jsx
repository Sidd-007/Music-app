...
const Filter = ({ setFilteredSongs }) => {
    ...
    return (
        <div className="w-full my-4 px-6 py-4 flex items-center justify-start md:justify-center gap-10">
            ...
            <div className=" flex items-center gap-6 mx-4">
                {filters?.map((data) => (
                    <p
                        ...
                        className={`text-base ${data.value === filterTerm ? "font-semibold text-[#00BD95]" : "font-normal"
                            } text-white cursor-pointer hover:font-semibold hover:text-[#00BD95] transition-all duration-100 ease-in-out`}
                    >
                        {data.name}
                    </p>
                ))}
            ...
            >
                <AiOutlineClear className="text-2xl text-white cursor-pointer" />
