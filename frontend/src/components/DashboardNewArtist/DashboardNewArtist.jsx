...
const DashboardNewArtist = () => {
    ...
    return (
        <div className="flex justify-center items-center">
            <div className="flex items-center justify-evenly flex-wrap bg-[#1E1E1E] rounded-md w-3/4 p-10 mt-10">
                <div className="bg-card  backdrop-blur-md w-full lg:w-225 h-225  rounded-md  cursor-pointer">
                ...
                <div className="flex flex-col items-center justify-center gap-4 mt-6">
                    <input
                        ...
                        className="w-full lg:w-300 p-3 rounded-md text-base font-semibold text-white outline-none shadow-sm bg-[#171717] bg-transparent"
                        value={artistName}
                        onChange={(e) => setArtistName(e.target.value)}
                    />

                    <div className="w-full lg:w-300 p-3 flex items-center rounded-md  shadow-sm bg-[#171717]">
