...
const DashboardSongs = () => {
    ...
    return (
        <div className="w-full p-4 flex items-center justify-center flex-col">
            ...
            <div className="relative w-full  my-4 p-4 py-12 bg-[#1E1E1E] mt-14 rounded-md">
...
export const SongContainer = ({ data }) => {
    return (
        <div className=" w-full  flex flex-wrap gap-20  items-center justify-evenly">
            {data &&
                data.map((song, i) => (
...
export const SongCard = ({ data, index }) => {
    ...
    return (
        <motion.div
            ...
            className="relative w-40 min-w-210 px-2 py-4 cursor-pointer hover:shadow-2xl hover:shadow-[#00BD95] shadow-[#00BD95] hover:bg-white bg-gray-100 shadow-md rounded-lg flex flex-col items-center"
        ...
        >
            ...
            <p className="text-base text-headingColor font-semibold my-2 flex justify-center items-center flex-col">
