...
const DashboardNewSong = () => {
    ...
    return (
        <div className="flex justify-center items-center flex-col">
            <div className="flex items-center justify-center p-4 bg-[#1E1E1E] rounded-md w-2/3">
                <div className="flex flex-col items-center justify-center gap-4 p-10">
                    <input
                        type="text"
                        placeholder="Type your song name"
                        className="w-full p-3 rounded-md text-base font-semibold text-[#171717] bg-[#00BD95] placeholder:text-white outline-none shadow-sm bg-transparent"
                        value={songName}
                        onChange={(e) => setSongName(e.target.value)}
                    />

                    <div className="flex w-full justify-between flex-wrap items-center gap-4 mt-4">
                    ...
                    <div className="flex items-center justify-between gap-2 w-full flex-wrap mt-4">
