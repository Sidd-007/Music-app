        ...
        <div className="w-full full flex items-center gap-3 overflow-hidden">
            ...
            >
                ...
                <div className="flex items-start flex-col">
                    ...
                    >
                        <RiPlayListFill className="text-white hover:text-[#00BD95] text-3xl cursor-pointer" />
                    </motion.i>
                </div>
                ...
                <div className="h-full flex items-center justify-center flex-col gap-3">
                    <motion.i whileTap={{ scale: 0.8 }} onClick={closeMusicPlayer}>
                        <IoMdClose className="text-gray-200  hover:text-white text-2xl cursor-pointer" />
                    </motion.i>
                    <motion.i whileTap={{ scale: 0.8 }} onClick={togglePlayer}>
                        <IoArrowRedo className="ay-200 text-white hover:text-red-700 text-2xl cursor-pointer" />
                    </motion.i>
                </div>
            </div>
