...
const DashboardUserCard = ({ data, index }) => {
    ...
    return (
        <motion.div
            ...
            className="relative w-full rounded-md flex items-center justify-between py-4  cursor-pointer bg-[#171717] hover:shadow-md mt-2"
        >
            ...
            <p className="text-base text-gray-100 w-275 min-w-[160px] text-center">{data.name}</p>
            <p className="text-base text-gray-100 w-275 min-w-[160px] text-center">{data.email}</p>
            <p className="text-base text-gray-100 w-275 min-w-[160px] text-center">{data.email_verfied ? 'True' : 'False'}</p>
            <p className="text-base text-gray-100 w-275 min-w-[160px] text-center">{createdAt}</p>
            <div className=" w-275 min-w-[160px] text-center flex items-center justify-center gap-6 relative">
                <p className="text-base text-gray-100"> {data.role}</p>
                {data._id !== user?.user._id && (
                    <motion.p
                        whileTap={{ scale: 0.75 }}
